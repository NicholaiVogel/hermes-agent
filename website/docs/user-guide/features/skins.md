...
| `readable-python` | Quiet styling for the Python CLI | `Hermes Agent` | Grayscale surfaces, brighter secondary text, and restrained warning/error colors. Pair with `display.final_response_markdown: render`. |
